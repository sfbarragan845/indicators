<template>
    <svg viewBox="0 0 24 24" class="h-4 w-full text-white  text-center" fill="none">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M6 7V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V7" stroke="currentColor"
